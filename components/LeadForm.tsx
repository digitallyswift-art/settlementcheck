...
export default function LeadForm({ verdict, offer, salary, years }: Props) {
  ...
  const inputClass =
    'border border-gray-200 rounded-xl px-4 py-3 w-full text-sm focus:ring-2 focus:ring-green-600 focus:border-transparent outline-none transition'
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-4">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-green-800 hover:bg-green-700 text-white font-bold py-4 px-6 rounded-xl text-base transition-colors disabled:opacity-60"
      >
