    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 24px;">
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin: 0 0 32px;">Thanks for applying to join the SettlementCheck solicitor panel. We've received your application for <strong>${firm_name}</strong> and will review it within 2 business days.</p>
